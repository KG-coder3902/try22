    ...
    <div class="container">
        <form name="RegForm" action=".\student-reg-update-php.php?user_id = <?php echo $ID;?>" method="post" onsubmit="return validateForm()">
            <div class="row">
                ...
                <div class="col">
                    <input type="radio" id="Isteacher" name="isteacher" value="yes" <?php if ($row['isteacher']=="yes") {echo "checked";}?>/>
                    <input type="radio" id="Isteacher" name="isteacher" value="no" hidden <?php if ($row['isteacher']=="no") {echo "checked";}?>/>
