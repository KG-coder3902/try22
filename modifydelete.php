        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Student's Data</h5>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href=\".\student profile\student-reg-update.php?userid=" . $data['user_id'] . "\"><button style = \"color: blue;\">update</button></a><br/><br/>
                                
                                <a href=\".\student profile\delete-data-prof.php?dId=" . $data['user_id'] . "\"class=\"delete\"><button style = \"color: red;\">delete</button></a></td>
                            </tr>
                        ";
                                        }
                                    } else {
